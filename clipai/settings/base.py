...
ALLOWED_HOSTS = env('ALLOWED_HOSTS') + ['.ngrok-free.dev', '.ngrok.io']
...
ASGI_APPLICATION = 'clipai.asgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'clipai.authentication.TrackingJWTAuthentication',
    ),
...
TIKTOK_REDIRECT_URI  = env(
    'TIKTOK_REDIRECT_URI',
    default='http://localhost:8000/api/videos/tiktok/callback/',
)
...
DEFAULT_FROM_EMAIL = env('EMAIL_HOST_USER', default='noreply@clipai.com')
